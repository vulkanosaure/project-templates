...
class NavigationDef 
{
	...
	public var delay(get, null):Null<Float>;
	public var dist(get, null):Null<Float>;
	public var fade(get, null):Bool;
	public var time(get, null):Null<Float>;
	public var easing(get, null):IEasing;
	public var callback(get, null):String->Void;
	
	
	public function new(__id:String, __side:String, __delay:Null<Float>, __dist:Null<Float> = 1100, __fade:Bool = false, __time:Null<Float> = 0.6, __easing:IEasing = null, __callback:String->Void = null) 
	{
		id = __id;
		side = __side;
		delay = __delay;
	...
	public function get_delay():Null<Float> 
	{
		return delay;
	}
	
	public function get_dist():Null<Float> 
	{
		return dist;
	}
	...
	public function get_time():Null<Float> 
	{
		return time;
	}
